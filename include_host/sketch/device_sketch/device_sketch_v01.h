...
#endif
#define QSKETCH_KERNEL_NAMESPACE Sketch_GPU_Thread2_Kernel
    ...
    void *debug)
{
    ...
    */
    ...
    for (size_t i = b + tid; i < e; i += warpSize) {
        ...
        size_t iv1 = hv % n;
        Count_T *ht = hash_table + iv1 * m;
        atomicAdd(ht + iv1 % m, 1);
...
struct Sketch_GPU_Thread2 : public Sketch_GPU<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function> {
