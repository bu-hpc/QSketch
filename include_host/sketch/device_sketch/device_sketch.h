...
struct Device_Hash_Table {
    ...
    bool use_zero_copy_memory = false;
    ...
    // int set_zero_copy_memory(bool flag) {
    //     if (flag == use_zero_copy_memory) {
    //         return 0; // flag unchanged, and nothing to do
    //     }
    //     if (use_zero_copy_memory = false && flag = true) {
    //         // move data from device memory to zero_copy_memory
    //     }

    //     if (use_zero_copy_memory = true && flag = false) {
    //         // move data from zero_copy_memory to device memory
    //     }
    //     use_zero_copy_memory = flag;
    //     return 0;
    // }
