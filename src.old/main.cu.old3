...
int main(int argc, char const *argv[])
{
    ...
    std::cout << "----------------------------------" << std::endl;
    {
        ...
        test.insert_perf_test(insert_keys_size, 1);
        test.clear();
        test.insert_perf_freq_test(insert_keys_size, 1);
        test.clear();
        // test.search_perf_test(insert_keys_size, search_keys_size, 1);
        // test.clear();
        // // test.search_accuracy_test(insert_keys_size, search_keys_size, insert_loop);
    ...
    //     Count_Min_Sketch_GPU_Mem_Levels<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function> map(
    //         static_cast<Insert_Kernel_Function_Mem_Levels *>(insert_warp_mem_threadfence_example1<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
    //         static_cast<Search_Kernel_Function_Mem_Levels *>(search_warp_mem_threadfence<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
    //         n, 1024 * 1024, seed_sz);
    ...
    //         // test.search_accuracy_test(insert_keys_size, search_keys_size, insert_loop);
    //         // test.clear();
    //         // auto err = test.search_accuracy_freq_test(insert_keys_size, search_keys_size, 1);
    //         // test.clear();
    //         // std::cout << "----------------" << i << "------------------" << std::endl;
    //         // if (err < 0) {
    ...
    //     Count_Min_Sketch_GPU_Mem_Levels<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function> map(
    //         static_cast<Insert_Kernel_Function_Mem_Levels *>(insert_warp_mem_threadfence_example4_1<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
    //         static_cast<Search_Kernel_Function_Mem_Levels *>(search_warp_mem_threadfence<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
    //         n, 1024 * 1024, seed_sz);
    ...
    //     Count_Min_Sketch_GPU_Mem_Levels<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function> map(
    //         static_cast<Insert_Kernel_Function_Mem_Levels *>(insert_warp_mem_threadfence_example4_2<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
    //         static_cast<Search_Kernel_Function_Mem_Levels *>(search_warp_mem_threadfence<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
    //         n, 1024 * 1024, seed_sz);
    ...
    //         test.insert_perf_freq_test(insert_keys_size, 1);
    //         test.clear();
    //         test.search_perf_freq_test(insert_keys_size, search_keys_size, 1);
    //         test.clear();
    //         test.search_accuracy_test(insert_keys_size, search_keys_size, insert_loop);
    //         test.clear();
    //         auto err = test.search_accuracy_freq_test(insert_keys_size, search_keys_size, 1);
...

    {
        ...
        // for (int i = 0; i < 10; ++i) {
        //     std::cout << "low_level_test: " << i << std::endl;
        //     test.insert_perf_test(insert_keys_size, 1);
        //     test.clear();
        //     test.search_perf_test(insert_keys_size, search_keys_size, 1);
        //     test.clear();
