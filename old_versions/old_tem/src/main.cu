...
using Insert_Kernel_Function_Mem_Levels_Loop = Count_Min_Sketch_GPU_Mem_Levels_Loop<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>::Insert_Kernel_Function;
using Search_Kernel_Function_Mem_Levels_Loop = Count_Min_Sketch_GPU_Mem_Levels_Loop<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>::Search_Kernel_Function;
using Insert_Kernel_Function_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop = Count_Min_Sketch_GPU_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop2<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>::Insert_Kernel_Function;
using Search_Kernel_Function_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop = Count_Min_Sketch_GPU_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop2<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>::Search_Kernel_Function;
...
int run_without_preload_host_pre_cal_sub_warp_loop2();
...
int main(int argc, char const *argv[])
{
    ...
    run_without_preload_host_pre_cal_sub_warp_loop2();
...
int run_example_5()
{
    ...
    {
        std::cout << "run_example_5_3" << std::endl;
        Unordered_Map_GPU<Key_T, Count_T> emap;

        Count_Min_Sketch_GPU_Mem_Levels_Loop<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function> map(
            static_cast<Insert_Kernel_Function_Mem_Levels_Loop *>(insert_warp_mem_threadfence_example5_3<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
            static_cast<Search_Kernel_Function_Mem_Levels_Loop *>(search_warp_mem_threadfence_example5_2<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
            n, 1024 * 1024, seed_sz);
...
int run_without_preload_host_pre_cal_sub_warp_loop2() {
    {
        std::cout << "run_without_preload_host_pre_cal_sub_warp_loop2" << std::endl;
        // size_t n = 65521;
        // size_t seed_sz = 4;
        // size_t m = 1;
        ...
        Count_Min_Sketch_GPU_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop2<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function> map(
            static_cast<Insert_Kernel_Function_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop *>(insert_warp_mem_threadfence_without_preload_pre_cal_sub_warp_loop2<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
            static_cast<Search_Kernel_Function_Mem_Levels_Host_Pre_Cal_Sub_Warp_Loop *>(search_warp_mem_threadfence_without_preload_pre_cal_sub_warp<Key_T, Count_T, Hashed_T, Seed_T, Hash_Function>),
            n_sub_warp, 1024 * 1024, seed_sz);
